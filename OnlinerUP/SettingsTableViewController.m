...
#define kRemoveAdsProductIdentifier @"com.sozdai.OnlinerUP.remads"
#define kUnlockUpProductIdentifier @"com.sozdai.OnlinerUP.enableupbutton"
...
- (void)tapsUnlockUpButton
{
    NSLog(@"User requests to remove ads");
    
    if([SKPaymentQueue canMakePayments]){
        NSLog(@"User can make payments");
        self.InappName = @"unlockUp";
        SKProductsRequest *productsRequest = [[SKProductsRequest alloc] initWithProductIdentifiers:[NSSet setWithObject:kUnlockUpProductIdentifier]];
        productsRequest.delegate = self;
        [productsRequest start];
